// Dafny program SlotMachineD.dfy compiled into C#
...
// Command-line arguments: build SlotMachineD.dfy
// SlotMachineD.dfy
...
module {:extern ""SM""} SM {
  class SlotMachineD {
    ...
    static method PlaceBet(balance: real, bet: real) returns (betAmount: real)
      ...
      decreases balance, bet
    {
      RuntimeRequires(bet >= 0.0, ""Invalid bet amount, must be non-negative"");
      RuntimeRequires(balance >= 0.0, ""Invalid balance, must be non-negative"");
      RuntimeRequires(bet <= balance, ""Bet amount exceeds balance"");
      if bet <= balance {
        betAmount := bet;
      } else {
        betAmount := balance;
...
module {:extern ""BS""} BS {
  ...
  class BinarySlotD {
      ...
      decreases combination, bet
    {
      ...
      RuntimeRequires(payout == if combination == 1 then 2.0 * bet else 0.0, ""Invalid payout calculation"");
      RuntimeRequires(payout >= 0.0, ""Invalid payout amount, must be non-negative"");
    }
  }
}
...
module {:extern ""TS""} TS {
  ...
  class TripleSlotD {
    ...
    static method CheckTripleCombination(reel1: Symbol, reel2: Symbol, reel3: Symbol)
        returns (isTriple: bool)
      ensures isTriple == if reel1 == reel2 && reel2 == reel3 then true else false
      decreases reel1, reel2, reel3
    {
    ...
    static method CheckDoubleCombination(reel1: Symbol, reel2: Symbol, reel3: Symbol)
        returns (isDouble: bool)
    ...
    static method getCombination(reel: Symbol, combination: int) returns (c: int)
      requires combination == if reel == cherry then 1 else if reel == lemon then 2 else if reel == orange then 3 else if reel == plum then 4 else if reel == bell then 5 else if reel == bar then 6 else 7
      ensures c == combination
      decreases reel, combination
    {
      RuntimeRequires(combination == if reel == cherry then 1 else if reel == lemon then 2 else if reel == orange then 3 else if reel == plum then 4 else if reel == bell then 5 else if reel == bar then 6 else 7, ""getCombination message: Invalid combination"");
      if reel == cherry {
        c := 1;
      } else if reel == lemon {
        c := 2;
    ...
    static method getMultiplier(combination: int, cType: CombinationType) returns (multiplier: int)
      ...
      ensures multiplier == if cType == Triple then if combination == 1 then 10 else if combination == 2 then 10 else if combination == 3 then 10 else if combination == 4 then 10 else if combination == 5 then 25 else if combination == 6 then 50 else if combination == 7 then 100 else 0 else if cType == Double then if combination == 1 then 2 else if combination == 2 then 1 else if combination == 3 then 1 else if combination == 4 then 1 else if combination == 5 then 5 else if combination == 6 then 10 else if combination == 7 then 15 else 0 else if cType == None then 0 else 0
      decreases combination, cType
    {
    ...
    static method CalculatePayout(bet: real, multiplier: int) returns (payout: real)
      ...
      ensures payout >= 0.0
      decreases bet, multiplier
    {
      RuntimeRequires(bet >= 0.0, ""Invalid bet amount, must be non-negative"");
      RuntimeRequires(multiplier >= 0, ""Invalid multiplier, must be non-negative"");
...
namespace SM {
  ...
  public partial class SlotMachineD {
    public SlotMachineD() {
    }
    public static void RuntimeRequires(bool cond, Dafny.ISequence<Dafny.Rune> message)
    {
      if (!(cond)) {
        throw new Dafny.HaltException("SlotMachineD.dfy(8,6): " + message.ToVerbatimString(false));}
    }
    public static Dafny.BigRational PlaceBet(Dafny.BigRational balance, Dafny.BigRational bet)
    {
      Dafny.BigRational betAmount = Dafny.BigRational.ZERO;
      SM.SlotMachineD.RuntimeRequires((bet) >= (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid bet amount, must be non-negative"));
      SM.SlotMachineD.RuntimeRequires((balance) >= (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid balance, must be non-negative"));
      SM.SlotMachineD.RuntimeRequires((bet) <= (balance), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Bet amount exceeds balance"));
      if ((bet) <= (balance)) {
        betAmount = bet;
      } else {
        betAmount = balance;
...
namespace BS {
  ...
  public interface _ICoin {
    bool is_heads { get; }
    bool is_tails { get; }
    _ICoin DowncastClone();
  }
  public abstract class Coin : _ICoin {
    public Coin() {
    }
    private static readonly BS._ICoin theDefault = create_heads();
    public static BS._ICoin Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<BS._ICoin> _TYPE = new Dafny.TypeDescriptor<BS._ICoin>(BS.Coin.Default());
    public static Dafny.TypeDescriptor<BS._ICoin> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ICoin create_heads() {
      return new Coin_heads();
    }
    public static _ICoin create_tails() {
      return new Coin_tails();
    }
    public bool is_heads { get { return this is Coin_heads; } }
    public bool is_tails { get { return this is Coin_tails; } }
    public static System.Collections.Generic.IEnumerable<_ICoin> AllSingletonConstructors {
      get {
        yield return Coin.create_heads();
        yield return Coin.create_tails();
      }
    }
    public abstract _ICoin DowncastClone();
  }
  public class Coin_heads : Coin {
    public Coin_heads() : base() {
    }
    public override _ICoin DowncastClone() {
      if (this is _ICoin dt) { return dt; }
      return new Coin_heads();
    }
    public override bool Equals(object other) {
      var oth = other as BS.Coin_heads;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "BS.Coin.heads";
      return s;
    }
  }
  public class Coin_tails : Coin {
    public Coin_tails() : base() {
    }
    public override _ICoin DowncastClone() {
      if (this is _ICoin dt) { return dt; }
      return new Coin_tails();
    ...
    public override bool Equals(object other) {
      var oth = other as BS.Coin_tails;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "BS.Coin.tails";
      return s;
    }
  }

  public partial class BinarySlotD {
    public BinarySlotD() {
    }
    public static void RuntimeRequires(bool cond, Dafny.ISequence<Dafny.Rune> message)
    {
      if (!(cond)) {
        throw new Dafny.HaltException("SlotMachineD.dfy(40,12): " + message.ToVerbatimString(false));}
    }
    public static BigInteger CheckWinningCombination(BS._ICoin reel)
    {
      BigInteger combination = BigInteger.Zero;
      if (object.Equals(reel, BS.Coin.create_heads())) {
        combination = BigInteger.One;
      } else {
        combination = BigInteger.Zero;
      }
      BS.BinarySlotD.RuntimeRequires((combination) == (((object.Equals(reel, BS.Coin.create_heads())) ? (BigInteger.One) : (BigInteger.Zero))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid combination"));
      return combination;
    }
    public static Dafny.BigRational CalculatePayout(BigInteger combination, Dafny.BigRational bet)
    {
      Dafny.BigRational payout = Dafny.BigRational.ZERO;
      BS.BinarySlotD.RuntimeRequires((bet) >= (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid bet amount, must be non-negative"));
      if ((combination) == (BigInteger.One)) {
        payout = (new Dafny.BigRational(BigInteger.Parse("2"), BigInteger.One)) * (bet);
      } else {
        payout = new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One);
      }
      BS.BinarySlotD.RuntimeRequires((payout) == ((((combination) == (BigInteger.One)) ? ((new Dafny.BigRational(BigInteger.Parse("2"), BigInteger.One)) * (bet)) : (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid payout calculation"));
      BS.BinarySlotD.RuntimeRequires((payout) >= (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid payout amount, must be non-negative"));
      return payout;
    }
  }
} // end of namespace BS
namespace TS {
  ...
  public interface _ISymbol {
    ...
    bool is_bar { get; }
    bool is_seven { get; }
    _ISymbol DowncastClone();
  }
  public abstract class Symbol : _ISymbol {
    public Symbol() {
    }
    private static readonly TS._ISymbol theDefault = create_cherry();
    public static TS._ISymbol Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<TS._ISymbol> _TYPE = new Dafny.TypeDescriptor<TS._ISymbol>(TS.Symbol.Default());
    public static Dafny.TypeDescriptor<TS._ISymbol> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ISymbol create_cherry() {
      return new Symbol_cherry();
    }
    public static _ISymbol create_lemon() {
      return new Symbol_lemon();
    }
    public static _ISymbol create_orange() {
      return new Symbol_orange();
    }
    public static _ISymbol create_plum() {
      return new Symbol_plum();
    }
    public static _ISymbol create_bell() {
      return new Symbol_bell();
    }
    public static _ISymbol create_bar() {
      return new Symbol_bar();
    }
    public static _ISymbol create_seven() {
      return new Symbol_seven();
    }
    public bool is_cherry { get { return this is Symbol_cherry; } }
    public bool is_lemon { get { return this is Symbol_lemon; } }
    public bool is_orange { get { return this is Symbol_orange; } }
    public bool is_plum { get { return this is Symbol_plum; } }
    public bool is_bell { get { return this is Symbol_bell; } }
    public bool is_bar { get { return this is Symbol_bar; } }
    public bool is_seven { get { return this is Symbol_seven; } }
    public static System.Collections.Generic.IEnumerable<_ISymbol> AllSingletonConstructors {
      get {
        yield return Symbol.create_cherry();
        yield return Symbol.create_lemon();
        yield return Symbol.create_orange();
        yield return Symbol.create_plum();
        yield return Symbol.create_bell();
        yield return Symbol.create_bar();
        yield return Symbol.create_seven();
      }
    }
    public abstract _ISymbol DowncastClone();
  }
  public class Symbol_cherry : Symbol {
    public Symbol_cherry() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_cherry();
    }
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_cherry;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.cherry";
      return s;
    }
  }
  public class Symbol_lemon : Symbol {
    public Symbol_lemon() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_lemon();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_lemon;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.lemon";
      return s;
    }
  }
  public class Symbol_orange : Symbol {
    public Symbol_orange() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_orange();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_orange;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.orange";
      return s;
    }
  }
  public class Symbol_plum : Symbol {
    public Symbol_plum() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_plum();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_plum;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.plum";
      return s;
    }
  }
  public class Symbol_bell : Symbol {
    public Symbol_bell() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_bell();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_bell;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.bell";
      return s;
    }
  }
  public class Symbol_bar : Symbol {
    public Symbol_bar() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_bar();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_bar;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.bar";
      return s;
    }
  }
  public class Symbol_seven : Symbol {
    public Symbol_seven() : base() {
    }
    public override _ISymbol DowncastClone() {
      if (this is _ISymbol dt) { return dt; }
      return new Symbol_seven();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.Symbol_seven;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.Symbol.seven";
      return s;
    }
  }

  public interface _ICombinationType {
    bool is_Triple { get; }
    bool is_Double { get; }
    bool is_None { get; }
    _ICombinationType DowncastClone();
  }
  public abstract class CombinationType : _ICombinationType {
    public CombinationType() {
    }
    private static readonly TS._ICombinationType theDefault = create_Triple();
    public static TS._ICombinationType Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<TS._ICombinationType> _TYPE = new Dafny.TypeDescriptor<TS._ICombinationType>(TS.CombinationType.Default());
    public static Dafny.TypeDescriptor<TS._ICombinationType> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ICombinationType create_Triple() {
      return new CombinationType_Triple();
    }
    public static _ICombinationType create_Double() {
      return new CombinationType_Double();
    }
    public static _ICombinationType create_None() {
      return new CombinationType_None();
    }
    public bool is_Triple { get { return this is CombinationType_Triple; } }
    public bool is_Double { get { return this is CombinationType_Double; } }
    public bool is_None { get { return this is CombinationType_None; } }
    public static System.Collections.Generic.IEnumerable<_ICombinationType> AllSingletonConstructors {
      get {
        yield return CombinationType.create_Triple();
        yield return CombinationType.create_Double();
        yield return CombinationType.create_None();
      }
    }
    public abstract _ICombinationType DowncastClone();
  }
  public class CombinationType_Triple : CombinationType {
    public CombinationType_Triple() : base() {
    }
    public override _ICombinationType DowncastClone() {
      if (this is _ICombinationType dt) { return dt; }
      return new CombinationType_Triple();
    }
    public override bool Equals(object other) {
      var oth = other as TS.CombinationType_Triple;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.CombinationType.Triple";
      return s;
    }
  }
  public class CombinationType_Double : CombinationType {
    public CombinationType_Double() : base() {
    }
    public override _ICombinationType DowncastClone() {
      if (this is _ICombinationType dt) { return dt; }
      return new CombinationType_Double();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.CombinationType_Double;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.CombinationType.Double";
      return s;
    }
  }
  public class CombinationType_None : CombinationType {
    public CombinationType_None() : base() {
    }
    public override _ICombinationType DowncastClone() {
      if (this is _ICombinationType dt) { return dt; }
      return new CombinationType_None();
    ...
    public override bool Equals(object other) {
      var oth = other as TS.CombinationType_None;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
    ...
    public override string ToString() {
      string s = "TS.CombinationType.None";
      return s;
    }
  }

  public partial class TripleSlotD {
    public TripleSlotD() {
    }
    public static void RuntimeRequires(bool cond, Dafny.ISequence<Dafny.Rune> message)
    {
      if (!(cond)) {
        throw new Dafny.HaltException("SlotMachineD.dfy(90,12): " + message.ToVerbatimString(false));}
    }
    public static bool CheckTripleCombination(TS._ISymbol reel1, TS._ISymbol reel2, TS._ISymbol reel3)
    {
      bool isTriple = false;
      if ((object.Equals(reel1, reel2)) && (object.Equals(reel2, reel3))) {
        isTriple = true;
      } else {
        isTriple = false;
      }
    ...
    public static bool CheckDoubleCombination(TS._ISymbol reel1, TS._ISymbol reel2, TS._ISymbol reel3)
    {
      bool isDouble = false;
      if (((object.Equals(reel1, reel2)) || (object.Equals(reel2, reel3))) || (object.Equals(reel1, reel3))) {
        if (!((object.Equals(reel1, reel2)) && (object.Equals(reel2, reel3)))) {
          isDouble = true;
        } else {
          isDouble = false;
    ...
    public static BigInteger getCombination(TS._ISymbol reel, BigInteger combination)
    {
      BigInteger c = BigInteger.Zero;
      TS.TripleSlotD.RuntimeRequires((combination) == (((object.Equals(reel, TS.Symbol.create_cherry())) ? (BigInteger.One) : (((object.Equals(reel, TS.Symbol.create_lemon())) ? (new BigInteger(2)) : (((object.Equals(reel, TS.Symbol.create_orange())) ? (new BigInteger(3)) : (((object.Equals(reel, TS.Symbol.create_plum())) ? (new BigInteger(4)) : (((object.Equals(reel, TS.Symbol.create_bell())) ? (new BigInteger(5)) : (((object.Equals(reel, TS.Symbol.create_bar())) ? (new BigInteger(6)) : (new BigInteger(7)))))))))))))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("getCombination message: Invalid combination"));
      if (object.Equals(reel, TS.Symbol.create_cherry())) {
        c = BigInteger.One;
      } else if (object.Equals(reel, TS.Symbol.create_lemon())) {
        c = new BigInteger(2);
      } else if (object.Equals(reel, TS.Symbol.create_orange())) {
        c = new BigInteger(3);
      } else if (object.Equals(reel, TS.Symbol.create_plum())) {
        c = new BigInteger(4);
      } else if (object.Equals(reel, TS.Symbol.create_bell())) {
        c = new BigInteger(5);
      } else if (object.Equals(reel, TS.Symbol.create_bar())) {
        c = new BigInteger(6);
      } else {
        c = new BigInteger(7);
      }
    ...
    public static BigInteger getMultiplier(BigInteger combination, TS._ICombinationType cType)
    {
      BigInteger multiplier = BigInteger.Zero;
      TS.TripleSlotD.RuntimeRequires(((object.Equals(cType, TS.CombinationType.create_Triple())) || (object.Equals(cType, TS.CombinationType.create_Double()))) || (object.Equals(cType, TS.CombinationType.create_None())), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("getMultiplier message: Invalid combination type"));
      TS.TripleSlotD.RuntimeRequires(((((((((combination).Sign == 0) || ((combination) == (BigInteger.One))) || ((combination) == (new BigInteger(2)))) || ((combination) == (new BigInteger(3)))) || ((combination) == (new BigInteger(4)))) || ((combination) == (new BigInteger(5)))) || ((combination) == (new BigInteger(6)))) || ((combination) == (new BigInteger(7))), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("getMultiplier message: Invalid combination"));
      if (object.Equals(cType, TS.CombinationType.create_Triple())) {
        if ((combination) == (BigInteger.One)) {
          multiplier = new BigInteger(10);
        } else if ((combination) == (new BigInteger(2))) {
          multiplier = new BigInteger(10);
        } else if ((combination) == (new BigInteger(3))) {
          multiplier = new BigInteger(10);
        } else if ((combination) == (new BigInteger(4))) {
          multiplier = new BigInteger(10);
        } else if ((combination) == (new BigInteger(5))) {
          multiplier = new BigInteger(25);
        } else if ((combination) == (new BigInteger(6))) {
          multiplier = new BigInteger(50);
        } else if ((combination) == (new BigInteger(7))) {
          multiplier = new BigInteger(100);
        } else {
          multiplier = BigInteger.Zero;
        }
      } else if (object.Equals(cType, TS.CombinationType.create_Double())) {
        if ((combination) == (BigInteger.One)) {
          multiplier = new BigInteger(2);
        } else if ((combination) == (new BigInteger(2))) {
          ...
          multiplier = new BigInteger(5);
        } else if ((combination) == (new BigInteger(6))) {
          multiplier = new BigInteger(10);
        } else if ((combination) == (new BigInteger(7))) {
          multiplier = new BigInteger(15);
        } else {
          multiplier = BigInteger.Zero;
        }
      } else if (object.Equals(cType, TS.CombinationType.create_None())) {
        multiplier = BigInteger.Zero;
      } else {
        multiplier = BigInteger.Zero;
      }
    ...
    public static Dafny.BigRational CalculatePayout(Dafny.BigRational bet, BigInteger multiplier)
    {
      Dafny.BigRational payout = Dafny.BigRational.ZERO;
      TS.TripleSlotD.RuntimeRequires((bet) >= (new Dafny.BigRational(BigInteger.Parse("0"), BigInteger.One)), Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid bet amount, must be non-negative"));
      TS.TripleSlotD.RuntimeRequires((multiplier).Sign != -1, Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Invalid multiplier, must be non-negative"));
      payout = (bet) * (new Dafny.BigRational((multiplier), BigInteger.One));
      return payout;
    }
  }
} // end of namespace TS
